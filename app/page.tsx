...
export default function HomePage() {
  ...
  const translations = {
    en: {
      ...
      whyChooseBarton: "Why Choose Barton",
    },
    fa: {
      recommendedForYou: "پیشنهاد شده برای شما",
      whyChooseBarton: "چرا بارتون را انتخاب کنیم",
    },
    ar: {
      recommendedForYou: "موصى لك",
      whyChooseBarton: "لماذا تختار بارتون",
    },
  };
  ...
  return (
      <div
          className={`min-h-screen bg-background ${currentLanguage.direction === "rtl" ? "rtl" : "ltr"}`}
          dir={currentLanguage.direction}
      >
        {/* Hero Section with search functionality and CTAs */}
        <HeroSection
        ...
        <div className="py-12">
          <div className="container mx-auto px-4">
            ...
            <ProductRecommendations currentLanguage={currentLanguage}/>
          </div>
        </div>
        ...
        <footer className="bg-slate-900 text-white py-12">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div>
                <h3 className="text-xl font-bold mb-4">Barton Wholesale</h3>
                <p className="text-slate-300">
                  Connecting businesses with suppliers and buyers in their
                  industry worldwide.
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-slate-300">Subscribe to our newsletter</p>
            ...
            <div className="mt-8 pt-8 border-t border-slate-700 text-center text-slate-400">
              <p>
                © {new Date().getFullYear()} Barton Wholesale Marketplace. All
                rights reserved.
              </p>
            </div>
          </div>
